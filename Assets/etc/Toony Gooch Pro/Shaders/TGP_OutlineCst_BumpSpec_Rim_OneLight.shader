...
Shader "Toony Gooch Pro/OutlineConst/OneDirLight/Bumped Specular Rim"
{
	Properties
	{
	...
	SubShader
	{
		...
		ENDCG
		UsePass "Hidden/ToonyGooch-Outline/OUTLINE_CONST"
	}
	
	Fallback "Toony Gooch Pro/OutlineConst/OneDirLight/Bumped Rim"
}
